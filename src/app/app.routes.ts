...
export const routes: Routes = [
    ...
    { path: 'imprimir-ticket-busqueda/:numTurno/:idMunicipio/:curp/:impresion', component: Registro, outlet: 'print' },
    { path: 'admin', component: LoginAdmin },
    { path: 'dashboard', component: Dashboard },
    { path: 'gestion', component: CrudTurnos },
    { path: 'info-turno/:numTurno/:idMunicipio/:curp', component: InfoTurno },
